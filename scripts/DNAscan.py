...
#   16.2 AnnotSV for structural variants
...
# 15.1 Clinical interpretation of variants with InterVar
        ...
        os.system("python3 %sIntervar.py --buildver %s -i %sannovar.vcf.avinput --input_type=AVinput -o %s/results/%s.intervar -d %s" % (path_intervar, reference, out, out, sample_name, path_annovar_db))
