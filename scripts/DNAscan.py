...
#   15.1 InterVar for small variant interpretation
#   15.2 AnnotSV for structural variant annotation and prioritisation
    ...
    if vcf:
        ...
        if "VC.log" in os.listdir(out + "logs"):
            ...
            if exome or mode == "intensive":
                ...
                #Freebayes calls both SNVs and indels in exome mode
                    if exome == "True":
                        os.system(
...
if annotation:
    if "annovar.log" in os.listdir(out + "logs"):
        ...
        os.system("cp %s/{annotate_variation, table_annovar, convert2annovar}.pl %s" % (path_annovar, path_intervar))
