...
parser.add_argument(
    ...
    help='bcftools filter string, eg "GQ>20 & DP>10" (Default = "QUAL > 1 & QUAL / INFO/AO > 10 & SAF > 0 & SAR > 0 & RPR > 1 & RPL > 1")')
    ...
    if os.path.isfile(file) == True:
        if os.path.getsize(file) != 0:
            if t == "bam":
                ...
                if f.fetch('chr1, chr2, chr3, chr4, chr5, chr6, chr7, chr8, chr9, chr10, chr11, chr12, chr13, chr14, chr15, chr16, chr17, chr18, chr19, chr20, chr21, chr22, chrX, chrY') != None:
                    print("\n%s has sufficient data for DNAscan to continue...\n" % file)
                else:
                    sys.exit("\nWARNING: %s only contains the header and no data, therefore DNAscan will now terminate.\n" % file)
                f.close()
