#Usage: bash install_dependencies_hg38.sh $path_to_setup_dir $path_to_DNASCAN_dir $path_to_ANNOVAR 
#Example: bash install_dependencies_hg38.sh /home/local/ /home/DNAscan /home/annovar 
