...
def create_parser():
  ...
  parser.add_argument(
      ...
      dest="fast_mode",
      help=
      'if this flag is set DNAscan2 will run without SV calling with Delly and the genotyping of STR loci identified with ExpansionHunter Denovo (Default = "True")',
      default=True)
