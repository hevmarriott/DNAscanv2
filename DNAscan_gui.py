...
col = [[sg.Frame(layout=[
[sg.MLine(size=(100,32), key='-ML-',autoscroll=True, write_only=False, reroute_stdout=True, reroute_stderr=True, reroute_cprint=True)],[sg.Button('Install Dependencies'), sg.Button('Add Advanced Options'), sg.Button('Add Read Group Info'), sg.Button('Run DNAscan'), sg.Text('', size=(7,1)), sg.Button('Reset')]], title="Output Window")],]
