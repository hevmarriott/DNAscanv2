...
[sg.Text('Read Type', size=(16,1), tooltip='If input format is fastq, select whether the reads are paired (1) or single (0) end'), sg.Combo(['0', '1'], size=(7,1), key='-paired', default_value='1')],
...
[sg.Checkbox(text='Alignment',key='-alignment', tooltip='SNV and Indels only: HISAT2 aligns all reads\nOptions besides SNV and indels: HISAT2 aligns all reads and BWA-MEM realigns any soft/hard-clipped and unaligned reads', size=(14,1)), sg.Checkbox(text='SNV/Indels', key='-variantcalling', tooltip='Strelka2 calls germline SNVs and indels', size=(14,1)), sg.Checkbox(text='Virus', key='-virus', tooltip='If selected, the genome will be scanned for the presence of viral DNA', size=(10,1)), sg.Checkbox(text='Bacteria', key='-bacteria', tooltip='If selected, the genome will be scanned for the presence of bacterial DNA', size=(14,1))],
[sg.Checkbox(text='Structural Variants', key='-SV', tooltip='Manta and Delly call all SV types', size=(14,1)), sg.Checkbox(text='Mobile Elements', key='-MEI', tooltip='MELT is used to call mobile insertion elements - i.e. Alu, SVA and LINE1 transposable elements', size=(14,1)), sg.Checkbox(text='Microbes', key='-custom_microbes', tooltip='If selected, the genome will be scanned for the presence of custom microbes', size=(10,1)), sg.Checkbox(text='Tandem Repeats', key='-STR', tooltip='If selected, a genome-wide short tandem repeat loci profile will be generated with ExpansionHunter Denovo.', size=(14,1))],
[sg.Checkbox(text='Repeat Expansions', key='-expansion', tooltip='ExpansionHunter is used to scan for and genotype known pathogenic repeat expansions from the repeat catalog specified in the paths_configs file', size=(14,1)), sg.Checkbox(text='Variant Annotation', key='-annotation', tooltip='SNP/Indels: ANNOVAR is used to annotate small variant calls using several databases (specified in paths_configs)\nStructural Variants/Mobile Element Insertions: AnnotSV annotates structural and transposable element calls using their integrated databases', size=(14,1)), sg.Checkbox(text='Iobio Services', key='-iobio', tooltip='If selected, a link to iobio services will be provided, which allows for on-the-fly variant interpretation and visualisation', size=(10,1)), sg.Checkbox(text='Genotype STR loci', key='-genotypeSTR', tooltip='If selected, the STR loci identified by checking Short Tandem Repeats will be genotyped with ExpansionHunter.\nWARNING: Depending on the sample coverage, this step can be computationally intensive', size=(14,1))],
[sg.Checkbox(text='Include Read Group', key='-RG', tooltip='If set, alignment will use the read group values provided in paths_configs', size=(14,1)), sg.Checkbox(text='Remove Duplicates', key='-rm_dup', tooltip='If set, DNAscan will remove duplicates from the alignment BAM file', size=(14,1)), sg.Checkbox(text='Debug Mode', key='-debug', tooltip='If selected, will keep the temporary and intermediate files after DNAscan has finished running', size=(10,1)), sg.Checkbox(text='Fast Mode', key='-fast_mode', tooltip='If selected, DNAscan2 will not call SVs with Delly and genotype STRs identified with ExpansionHunter Denovo', size=(14,1))],
[sg.Text('Reports:', size=(35,1), font="Helvetica 10 bold"), sg.Text('Regions:', size=(10,1), font="Helvetica 10 bold")],
[sg.Checkbox(text='Sequencing', key='-sequencing_report', tooltip='If selected, a sequencing quality report will be generated with FastQC', size=(14,1)), sg.Checkbox(text='Alignment', key='-alignment_report', tooltip='If selected, an alignment report will be generated with samtools flagstat', size=(14,1)), sg.Checkbox(text='Exome', key='-exome', tooltip='If selected, analysis will be restricted to exonic regions',size=(10,1)), sg.Checkbox(text='Custom (BED)', key='-BED', tooltip='If selected, analysis will be restricted to custom regions specified in a BED file in paths_configs', size=(14,1))],
[sg.Checkbox(text='Variant Calling', key='-calls_report', tooltip='If selected, an SNV and indel calls report will be generated using bcftools stats', size=(14,1)), sg.Checkbox(text='Annotation', key='-results_report', tooltip='SNVs/Indels: ANNOVAR results will be converted into a TSV report\nStructural Variants/Mobile Element Insertions: An HTML results report will be generated with knotAnnotSV\nBoth: Reports will be generated as above, with the addition of a concise report describing the basic characteristics of called simple and structural variants', size=(14,1)), sg.Checkbox(text='ALS Genes', key='-alsgenescanner', tooltip='If selected, analysis will be restricted to ALS genes as part of ALSGeneScanner', size=(10,1))],
[sg.Text('Advanced Options:', size=(42,1), font="Helvetica 10 bold", tooltip='These options are only required if you want to customise alignment, MEI and/or SV annotation or you want to restrict analysis\nto custom regions listed in either a BED file or a gene list and have not manually inputted them into paths_configs'), sg.Text('Read Group Information:', size=(21,1), font="Helvetica 10 bold", tooltip='These options are only required if you want to override the default read group\n parameters in paths_configs and have not inputted them manually. If you want to change a value\nremove the quotations and replace with a value (without quotes), otherwise leave blank.')],
[sg.Text('BED File', size=(15,1)), sg.InputText('""', size=(20,1), key='-path_bed', tooltip='Path to BED file'), sg.FileBrowse(), sg.Text('ID', size=(12,1)), sg.InputText('""', size=(10,1), key='-RG_ID', tooltip='Read Group Identifier', )],
[sg.Text('Gene List', size=(15,1)), sg.InputText('""', size=(20,1), key='-path_gene_list', tooltip='Path to gene list'), sg.FileBrowse(), sg.Text('Library', size=(12,1)), sg.InputText('""', size=(10,1), key='-RG_LB', tooltip='DNA Preparation Library Identifier')],
[sg.Text('HISAT Options', size=(15,1)), sg.InputText('""', size=(20,1), key='-hisat_custom_options'), sg.Text('                Platform', size=(20,1)), sg.InputText('""', size=(10,1), key='-RG_PL', tooltip='Sequencing technology used i.e. ILLUMINA')],
[sg.Text('BWA Options', size=(15,1)), sg.InputText('""', size=(20,1), key='-bwa_custom_options'), sg.Text('                Platform Unit', size=(20,1)), sg.InputText('""', size=(10,1), key='-RG_PU', tooltip='Flowcell and Lane info in the format FLOWCELL_BARCODE:LANE:SAMPLE_BARCODE')],
[sg.Text('AnnotSV Options', size=(15,1)), sg.InputText('""', size=(20,1), key='-annotsv_custom_options'), sg.Text('                Sample', size=(20,1)), sg.InputText('""', size=(10,1), key='-RG_SM', tooltip='Sample sequenced in the read group')],
